...
class BMSDBSql():
    ...
    def __init__(self, filename="./db/bms.db"):
        """
...
if __name__ == "__main__":
    ...
    sql.execute("insert into books (book_name, book_SN, status, user_id,user_name) values (?,?,?,?,?);",
                [('冰与火之歌', '202402-1', 0, 0, ''),
                 ('Alice in wonder', '202402-2', 0, 0, ''),
                 ('Robinson', '202402-3', 1, 1, 'andy')])
